...
> *GHXSTSHIP is a full-service experiential production, operations, and technology company headquartered in Miami, with offices in Las Vegas, Chicago, New York, and Los Angeles. We are the general contractor, foreman, and Procore equivalents for experiential projects — delivering Production Management, Operations Leadership, and Technology Implementation for festivals, concerts and tours, brand activations, immersive experiences, and sporting events.*
...
## 3 — TECHNOLOGY IMPLEMENTATION  ·  *The Procore*
...
## THE TERMINAL — the brand's organizing metaphor
...
(GC/Foreman/Procore), Selected Work (**The Log**), numbers band, trust band. Primary CTA: **Start a
Project**. Positioning: the General Contractor, Foreman & Procore of experiential projects. Aesthetic:
Vintage Reef. Voice: Yacht Builder + Expedition Creator (light texture, never corny).

> Earlier framings (space-cruise booking, Skeleton Crew, Set Sail / Book Your Voyage, terminal/concourse
> wayfinding) are **retired** — superseded by the journey×GC model above.

**The team is the Skeleton Crew** — ranks map to roles (Captain = Executive Producer, First Mate =
Production Director, Navigator = Project Management, Quartermaster = Logistics & Ops, Bosun = Technical
Director). Recruiting/education = "Join the Crew · learn the ropes."
