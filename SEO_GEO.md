...
- **Four-service taxonomy** (Experiential Production · Site Operations · Venue & Site Operations · Immersive
...
## SEO (classic search)
- **`<title>`** ≤ 60 chars, primary keyword first: e.g. *"Experiential Production, Site Operations & Venue & Site Operations. GHXSTSHIP."*
...
- **The nine-phase Itinerary** applied to that service (reuse `.gx-smap`).
...
The homepage already ships `Organization` (+audience), `HowTo` (the nine phases), `SoftwareApplication`
