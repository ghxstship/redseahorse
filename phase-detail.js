...
(function () {
  ...
  var CSS = '' +
    '.smap .stop,.gx-smap__stop,.seven .dstep{cursor:pointer;outline:none}' +
    '.seven .dstep{transition:transform .12s ease}' +
    ...
    '.smap .stop.phase-active .dot,.gx-smap__stop.phase-active .gx-smap__dot{background-color:var(--brass)!important;background-image:none!important;border-color:var(--brass)!important;color:var(--on-brass,#001800)!important;box-shadow:0 0 0 6px rgba(46,219,58,.34)!important}' +
