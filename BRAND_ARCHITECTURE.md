...
**Definition:** The operational leadership layer that runs the crew and the day-of execution, the
foreman who makes complex productions predictable, on time, on budget, at any scale.
...
## 3. TECHNOLOGY INNOVATIONS  ·  *The Procore*
**Definition:** The platform layer that coordinates the entire project, proprietary software and
integrated event technology, the Procore of experiential production.
**Products:**
- **ATLVS**, production & resource management platform (project management, resource allocation).
- **COMPVSS**, enterprise workforce & crew management (scheduling, certifications, timesheets).
- **GVTEWAY**, ticketing, fan engagement & community platform.
**Also:** interactive & experiential technology, integrations, data/analytics.
**Primary keywords:** event production software, crew scheduling software, workforce management
software, event ticketing platform, experiential technology.

---

## 🔑 SURFACE REGISTER, metaphor vs. plain language (governance)
The voyage/spaceport metaphor is for **marketing & brand surfaces** (website, social, pitch deck, brand
collateral). On **operational surfaces the end user transacts in** (the ATLVS/COMPVSS/GVTEWAY apps, client
documents, transactional email) use the **literal terms users expect**, the metaphor only as light accent.

| Marketing term | Operational term (apps / docs) |
|---|---|
| Voyage | **Project** (RRR codes = **Project ID**) |
| Departures / Arrivals board | **Projects** list |
| Itinerary | Production lifecycle / Phases |
| Charters · Set Your Course | Engagement / Scope |
| The Bridge / Atlas / Compass / Gateway | Lead with product names **ATLVS / COMPVSS / GVTEWAY**; nicknames as subtitle |
| All Aboard / Board | Sign in · Start · Launch |
| Skeleton Crew | Crew / Roster / Team |
| Mission Control | **Dashboard** |
| Box Office | **Sales** |
| Post a Call | **Post a Role** (job posting) |
| Launch / New Project | standard ERP create action |
| Strike (project) | Close / Complete |

## THE TERMINAL, the brand's organizing metaphor  ·  ⚠️ RETIRED, REFERENCE ONLY

> ⚠️ **Retired model, kept for reference only.** The Spaceport / Terminal wayfinding metaphor in this
> section (and its metaphor-lock tables) is **superseded by the journey×GC model** documented under
> *Nav / journey sequence (site)* at the foot of this file. Do **not** build new surfaces from the
> Terminal lexicon (Concourses, Gates, Departures board, Boarding pass, Ways to Sail). Use the current
> sequence instead: **The Destination → The Ship → The Course → The Crew → The Manifest → Launch**,
> with the GC/Foreman/Procore capability stack, **The Archives** for past work / case studies, and **The Log** for articles & news.

GHXSTSHIP is presented as **the GHXSTSHIP Spaceport**, a transit terminal, where
...
*underway* (live), *charted course*, and ship/compass/anchor/galleon icons. Departures, Flight Path, and
"boarding" still read naturally because a solar galleon flies.

**🔒 Metaphor locks (one referent each, do not blur):**
...
| **Home Ports** | The **offices** | Miami = flagship home port; + Las Vegas, Chicago, NY, LA. |

Future metaphor slots (unused, available): **Captain's Log / Dispatches** = blog · **Crow's Nest** =
trends/foresight · **Cargo & Manifest** = scope/deliverables · **Maiden Voyage** = a client's first project ·
**Star Charts** = strategy/creative R&D · **Boarding Pass** = the proposal/engagement (and GVTEWAY ticket).
...
| **Pictograms** | Wayfinding icon set | Labels, status, metadata |

### Destinations, industry verticals (the "where")
Festivals · Concerts & Tours · Brand Activations · Immersive Experiences · Sporting Events ·
TV, Film & Broadcast · Health & Wellness · Premium Hospitality · Luxury Retail · Water & Motorsports · Corporate & Private. These are the destinations on the departures board; each project
is a *flight* to one of them.
...
> journey×GC model above. The 6-step journey rail and the GC/Foreman/Procore stack are the live system.

**The team is The Crew** (internally still flavored as the *Skeleton Crew*), ranks map to roles (Captain = Executive Producer, First Mate =
Production Director, Navigator = Project Management, Quartermaster = Logistics & Ops, Bosun = Technical
Director). The public section/nav label is **The Crew**; reserve "Skeleton Crew" for internal/recruiting color. Recruiting/education = "Join the Crew · learn the ropes."
