...
export default function Page() {
  ...
  *{box-sizing:border-box}
  ...
  .filters{display:flex;gap:var(--space-10);flex-wrap:wrap;padding:var(--space-26) 0 0}
  .filters button{font-family:var(--font-mono);font-size:var(--fs-label);letter-spacing:.1em;text-transform:uppercase;background:var(--ink-2);color:var(--fg-on-dark-2);border:var(--stroke-2) solid var(--ink-3);border-radius:var(--r-pill);padding:var(--sp-2) var(--space-14);cursor:pointer}
  .filters button.on,.filters button:hover{border-color:var(--brass);color:var(--brass)}
  .pad{padding:var(--space-32) 0 var(--space-56)}
  .gal{display:grid;grid-template-columns:repeat(4,1fr);grid-auto-rows:172px;gap:var(--space-14)}
  ...
  .tile .tag{position:absolute;left:var(--space-10);top:var(--space-10);font-family:var(--font-mono);font-size:var(--fs-label);letter-spacing:.1em;text-transform:uppercase;background:var(--ink);color:var(--brass);padding:var(--sp-1) var(--sp-2);border-radius:var(--r-1)}
  .tile .cap{position:absolute;left:0;right:0;bottom:0;font-family:var(--font-mono);font-size:var(--fs-label);letter-spacing:.08em;text-transform:uppercase;color:var(--bone);background:linear-gradient(transparent,rgba(6,12,12,.9));padding:var(--space-26) var(--sp-3) var(--space-10)}
