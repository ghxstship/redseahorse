...
export const metadata: Metadata = {
  title: "GVTEWAY \u2014 Ticketing & Fan Engagement",
  description: "GVTEWAY is GHXSTSHIP's ticketing, access, and fan-engagement platform \u2014 the gateway between the audience and the experience, from on-sale to entry to community.",
  alternates: { canonical: "https://ghxstship.tours/gvteway" },
};
...
export default function Page() {
  ...
  /* Product accent: remap the jade accent to the GVTEWAY color within page content (nav/footer stay global jade). */
  main{--brass:var(--gvteway);--brass-deep:var(--gvteway-deep);--halftone-brass:color-mix(in srgb, var(--gvteway) 16%, transparent)}
` }} />
...
<div className="wrap"><p className="crumbs"><Link href="/">Home</Link> / <span style={{color: 'var(--brass)'}}>GVTEWAY</span></p></div>
<main>
<section className="hero"><div className="wrap">
  <p className="eyebrow">The Instruments &middot; GVTEWAY &middot; The Gateway</p>
  <h1>GVTEWAY<br/>The <span className="pop">Gateway.</span></h1>
  <p className="answer">GVTEWAY is the ticketing, access, and fan-engagement platform — the gateway between your audience and the experience. On-sale, access control, and community, run on the same system that builds the show, so the fan journey is part of the build, not an afterthought.</p>
...
<section className="pad"><div className="wrap">
  ...
  <h2 className="sec">Open the Gate.</h2>
  <div className="sgrid"><div className="scard"><i className="ph-bold ph-ticket"></i><h3>Ticketing &amp; On-Sale</h3><p>On-sale, allocations, and pricing for festivals, tours, and activations — built into the production.</p></div><div className="scard"><i className="ph-bold ph-scan"></i><h3>Access &amp; Entry</h3><p>Access control and entry that move crowds cleanly and keep the gate secure on game day.</p></div><div className="scard"><i className="ph-bold ph-megaphone"></i><h3>Fan Engagement</h3><p>Audience data and engagement that turn one event into a returning community.</p></div></div>
</div></section>
<section className="pad alt"><div className="wrap">
  <p className="eyebrow">Answers</p>
  <h2 className="sec">FAQ.</h2>
  <div className="faq"><details open><summary>What is GVTEWAY?<span className="ic">+</span></summary><p className="a">GVTEWAY is GHXSTSHIP's event ticketing, access, and fan-engagement platform — the gateway from on-sale to entry to community.</p></details><details><summary>Who is it for?<span className="ic">+</span></summary><p className="a">Promoters, venues, and brands who want ticketing and fan engagement coordinated with the rest of the production, not bolted on.</p></details><details><summary>How does it fit the fleet?<span className="ic">+</span></summary><p className="a">GVTEWAY opens the gate while ATLVS charts the course and COMPVSS points the crew — three instruments, one yard.</p></details></div>
</div></section>
<section className="cta"><div className="wrap"><h2>Run It on<br/>GVTEWAY.</h2>
