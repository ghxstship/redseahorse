...
export default function Page() {
  ...
  .sgrid{display:grid;grid-template-columns:repeat(3,1fr);gap:var(--sp-4);padding:36px 0 0}@media(max-width:880px){.sgrid{grid-template-columns:1fr}}
  ...
  .scard h3{font-family:var(--font-display);font-weight:900;font-size:var(--fs-h3);text-transform:uppercase;margin:14px 0 var(--sp-2);line-height:.98}
  .scard p{font-size:14.5px;line-height:1.55;color:var(--fg-on-dark-2);margin:0}
  .who{display:grid;grid-template-columns:repeat(3,1fr);gap:var(--sp-4);padding:36px 0 0}@media(max-width:880px){.who{grid-template-columns:1fr}}
  ...
  .faq summary{list-style:none;cursor:pointer;padding:18px 0;display:flex;justify-content:space-between;gap:20px;font-family:var(--font-display);font-weight:800;font-size:var(--fs-body-l);color:var(--bone)}
  ...
  .faq .a{padding:0 0 20px;font-size:var(--fs-body);line-height:1.6;color:var(--fg-on-dark-2);max-width:880px}/*__nf__*/
  header.nav{position:sticky;top:0;z-index:50;background:var(--void);border-bottom:var(--stroke-3) solid var(--ink-3)}
  .nav-inner{display:flex;align-items:center;justify-content:space-between;min-height:72px;padding:10px 0}
