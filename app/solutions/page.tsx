...
<section className="pad"><div className="wrap">
  ...
  <div className="sgrid">
    <div className="scard"><i className="ph-bold ph-flag"></i><h3>Experiential Production</h3><p>The general contractor for live experiences: design, scenic fabrication, staging, technical production, and show calling, with the scope and the budget owned end to end.</p><p style={{margin: 'var(--space-14) 0 0'}}><Link href="/services/experiential-production" style={{fontFamily: 'var(--font-mono)', fontSize: 'var(--fs-label)', letterSpacing: '.1em', textTransform: 'uppercase', color: 'var(--brass)', textDecoration: 'none'}}>Explore Experiential Production →</Link></p></div>
    <div className="scard"><i className="ph-bold ph-anchor"></i><h3>Site Operations</h3><p>The foreman on the ground: logistics, crew and workforce, vendor management, health and safety, and the day-of call at any scale.</p><p style={{margin: 'var(--space-14) 0 0'}}><Link href="/services/site-operations" style={{fontFamily: 'var(--font-mono)', fontSize: 'var(--fs-label)', letterSpacing: '.1em', textTransform: 'uppercase', color: 'var(--brass)', textDecoration: 'none'}}>Explore Site Operations →</Link></p></div>
    <div className="scard"><i className="ph-bold ph-boat"></i><h3>Venue Management</h3><p>The harbor master for the room: programming, bookings, facility and vendor operations, and on-site teams. The space, managed start to finish.</p><p style={{margin: 'var(--space-14) 0 0'}}><Link href="/services/venue-management" style={{fontFamily: 'var(--font-mono)', fontSize: 'var(--fs-label)', letterSpacing: '.1em', textTransform: 'uppercase', color: 'var(--brass)', textDecoration: 'none'}}>Explore Venue Management →</Link></p></div>
    <div className="scard"><i className="ph-bold ph-compass"></i><h3>Immersive Technologies</h3><p>The Procore for the project: <span className="pn-atlvs">ATLVS</span>, <span className="pn-compvss">COMPVSS</span>, <span className="pn-gvteway">GVTEWAY</span>, and <span className="pn-legend">LEG3ND</span> plus immersive show systems, integrations, and analytics. The platforms the whole build runs on.</p><p style={{margin: 'var(--space-14) 0 0'}}><Link href="/services/immersive-technologies" style={{fontFamily: 'var(--font-mono)', fontSize: 'var(--fs-label)', letterSpacing: '.1em', textTransform: 'uppercase', color: 'var(--brass)', textDecoration: 'none'}}>Explore Immersive Technologies →</Link></p><p style={{margin: 'var(--space-6) 0 0'}}><a href="https://atlvs.pro" target="_blank" rel="noopener" style={{fontFamily: 'var(--font-mono)', fontSize: 'var(--fs-label)', letterSpacing: '.1em', textTransform: 'uppercase', color: 'var(--plasma)', textDecoration: 'none'}}>Explore the platforms at <span className="pn-atlvs">ATLVS</span>.pro</a></p></div>
  </div>
</div></section>
...
<section className="pad"><div className="wrap">
  ...
  <h2 className="sec">The Services, Answered.</h2>
  <div className="faq">
