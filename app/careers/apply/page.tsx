...
export default function Page() {
  ...
  .field .hint { font-size: 11px; letter-spacing: 0.04em; color: color-mix(in srgb, var(--color-text) 55%, transparent); margin: 6px 0 0; }
  .consent { display: flex; gap: 10px; align-items: flex-start; font-size: 13px; line-height: 1.55; font-weight: 400; letter-spacing: 0; text-transform: none; color: color-mix(in srgb, var(--color-text) 72%, transparent); cursor: pointer; }
  ...
  .rail-blk li, .rail-blk p { font-size: 13px; line-height: 1.6; color: color-mix(in srgb, var(--color-text) 72%, transparent); margin: 0 0 7px; }
` }} />
