...
<section className="pad"><div className="wrap"><div className="cgrid">
  <form>
    ...
    <div className="field"><label htmlFor="rs">R&eacute;sum&eacute; / CV</label><input id="rs" type="file" accept=".pdf,.doc,.docx" name="resume-cv"/><p style={{fontFamily: 'var(--font-mono)', fontSize: 'var(--fs-label)', letterSpacing: '.06em', color: 'var(--fg-on-dark-3)', margin: 'var(--space-6) 0 0'}}>PDF or Word &middot; up to 3 MB</p></div>
