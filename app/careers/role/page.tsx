...
export default function Page() {
  ...
  .jd-prose h2 { font-size: 1.333rem; margin: 30px 0 10px; }
  ...
  .jd-meta .r { display: flex; justify-content: space-between; gap: 12px; padding: 9px 0; border-bottom: 1px solid var(--color-divider); font-size: 0.867rem; }
  .jd-meta .r:last-of-type { border-bottom: 0; }
  .jd-meta .k { font-size: 0.733rem; letter-spacing: 0.08em; text-transform: uppercase; font-weight: 600; color: color-mix(in srgb, var(--color-text) 55%, transparent); }
...
<section className="wrap sec-pad-sm"><div className="jd">
  <div className="jd-prose">
    ...
    <p>GHXSTSHIP is a professional services firm for live and experiential projects — experiential design and production, venue and site operations, tour and talent management, and technology and systems implementation — headquartered in Miami, with primary offices in Chicago, Los Angeles, and New York City, and satellite offices in Nashville, Denver, Las Vegas, and Phoenix. We build festivals, tours, activations, immersive worlds, and sporting events end to end.</p>
