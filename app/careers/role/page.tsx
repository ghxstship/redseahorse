...
export default function Page() {
  ...
  h1{font-family:var(--font-display);font-weight:900;font-size:clamp(44px,7vw,84px);line-height:0.97;text-transform:uppercase;letter-spacing:-.015em;margin:0 0 var(--sp-4)}h1 .pop{color:var(--brass)}
  ...
  .pad{padding:var(--space-56) 0}h2.sec{font-family:var(--font-display);font-weight:900;font-size:clamp(30px,4.2vw,48px);line-height:0.98;text-transform:uppercase;margin:0 0 var(--space-14)}
  .cta{padding:var(--space-80) 0;text-align:center;border-top:var(--stroke-2) solid var(--ink-3)}.cta h2{font-family:var(--font-display);font-weight:900;font-size:clamp(38px,6.5vw,78px);line-height:0.96;text-transform:uppercase;margin:0 0 var(--space-22)}.cta .row{display:flex;gap:var(--space-14);justify-content:center;flex-wrap:wrap}
...
<section className="pad"><div className="wrap"><div className="jl">
  <div className="prose">
    ...
    <ul><li>Own on-site load-in, build, and strike for assigned productions</li><li>Sequence crew calls, freight, and vendor deliveries against the schedule</li><li>Run the floor day-of &mdash; holding the standard and solving problems in real time, with safety first</li><li>Manage the technical package with the Technical Director</li><li>Track labor, hours, and on-site spend against the budget</li><li>Close out each build with reconciliation and a debrief</li></ul>
