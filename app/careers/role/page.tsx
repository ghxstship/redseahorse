...
<div class="wrap"><p class="crumbs"><a href="/">Home</a> / <a href="/">Careers</a> / <span style="color:var(--brass)">Production Manager</span></p></div>
<main><section class="hero"><div class="wrap">
  <span class="badge">Production &middot; Full-time</span>
  <p class="eyebrow">Open Role</p>
  <h1>Production <span class="pop">Manager.</span></h1>
  <p class="answer">The Production Manager runs the floor build and the technical package on site &mdash; owning load-in, the crew call, and the day-of standard for festivals, activations, and live events.</p>
</div></section>
<section class="pad"><div class="wrap"><div class="jl">
  <div class="prose">
    ...
    <div style="display:flex;gap:14px;flex-wrap:wrap;margin-top:24px"><a class="gx-btn gx-btn--lg" href="/apply">Apply for This Role</a><a class="gx-btn gx-btn--ghost gx-btn--lg" href="/">All Open Roles</a></div>
  </div>
  <aside><div class="meta-card">
    <div class="r"><span class="k">Department</span><span class="v">Production</span></div>
    <div class="r"><span class="k">Type</span><span class="v">Full-time</span></div>
    <div class="r"><span class="k">Location</span><span class="v">Miami, FL</span></div>
    <div class="r"><span class="k">Travel</span><span class="v">Frequent</span></div>
    <div class="r"><span class="k">Reports To</span><span class="v">Production Director</span></div>
    <div style="margin-top:16px"><a class="gx-btn gx-btn--sm" href="/apply" style="width:100%;justify-content:center">Apply Now</a></div>
  </div></aside>
...
const __jsonLd: string[] = [
  `{"@context":"https://schema.org","@type":"JobPosting","title":"Production Manager","description":"Own on-site load-in, build, crew calls, and the day-of standard for experiential and entertainment productions.","datePosted":"2026-06-06","employmentType":"FULL_TIME","hiringOrganization":{"@type":"Organization","name":"GHXSTSHIP","sameAs":"https://ghxstship.tours/"},"jobLocation":{"@type":"Place","address":{"@type":"PostalAddress","addressLocality":"Miami","addressRegion":"FL","addressCountry":"US"}},"industry":"Experiential Production"}`,
];
