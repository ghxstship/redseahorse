...
export default function Page() {
  return (
    <>
      <style dangerouslySetInnerHTML={{ __html: `*{box-sizing:border-box}html,body{margin:0;background:var(--void);color:var(--bone);font-family:var(--font-body);-webkit-font-smoothing:antialiased}a{color:inherit}.wrap{max-width:1180px;margin:0 auto;padding:0 var(--sp-6)}
  .crumbs{font-family:var(--font-mono);font-size:var(--fs-label);letter-spacing:.12em;text-transform:uppercase;color:var(--fg-on-dark-3);padding:20px 0 0}.crumbs a{text-decoration:none}.crumbs a:hover{color:var(--brass)}
  .eyebrow{font-family:var(--font-mono);font-size:var(--fs-small);letter-spacing:.22em;text-transform:uppercase;color:var(--brass);margin:0 0 14px;display:flex;align-items:center;gap:10px}.eyebrow::before{content:"\\25C6";color:var(--nebula)}
...
.jl{display:grid;grid-template-columns:1.6fr .8fr;gap:40px;padding:36px 0 0}@media(max-width:820px){.jl{grid-template-columns:1fr}}
  .prose h2{font-family:var(--font-display);font-weight:900;font-size:var(--fs-h3);text-transform:uppercase;margin:30px 0 var(--sp-3);line-height:1}
  .prose p{font-size:var(--fs-body);line-height:1.7;color:var(--fg-on-dark-1);margin:0 0 14px}
  .prose ul{margin:0 0 14px;padding-left:18px}.prose li{font-size:var(--fs-body);line-height:1.7;color:var(--fg-on-dark-2);margin-bottom:7px}
  ...
  .meta-card .r{display:flex;justify-content:space-between;gap:var(--sp-3);padding:9px 0;border-bottom:var(--stroke-2) solid var(--ink-3);font-size:var(--fs-small)}
  ...
  .badge{display:inline-block;font-family:var(--font-mono);font-size:var(--fs-label);letter-spacing:.1em;text-transform:uppercase;color:var(--brass);border:var(--stroke-1) solid var(--ink-3);border-radius:var(--r-pill);padding:var(--sp-1) 10px;margin-bottom:14px}
/*__nf__*/
  ...
  .site-foot .foot-social{display:flex;gap:14px}.site-foot .foot-social a{color:var(--fg-on-dark-2);font-size:var(--fs-body-l);text-decoration:none}.site-foot .foot-social a:hover{color:var(--brass)}
  ...
  .site-foot .foot-col a{display:block;font-size:var(--fs-small);color:var(--fg-on-dark-2);text-decoration:none;margin-bottom:9px}.site-foot .foot-col a:hover{color:var(--bone)}
...
<section className="pad"><div className="wrap"><div className="jl">
  <div className="prose">
    ...
    <div style={{display: 'flex', gap: '14px', flexWrap: 'wrap', marginTop: 'var(--sp-5)'}}><Link href="/careers/apply" className="gx-btn gx-btn--lg">Apply for This Role</Link><Link href="/careers" className="gx-btn gx-btn--ghost gx-btn--lg">All Open Roles</Link></div>
  </div>
