...
.filters{display:flex;gap:10px;flex-wrap:wrap;padding:var(--sp-5) 0 0}.filters button{font-family:var(--font-mono);font-size:var(--fs-label);letter-spacing:.1em;text-transform:uppercase;background:var(--ink-2);color:var(--fg-on-dark-2);border:var(--stroke-2) solid var(--ink-3);border-radius:var(--r-pill);padding:var(--sp-2) 14px;cursor:pointer}.filters button.on,.filters button:hover{border-color:var(--brass);color:var(--brass)}
  .jobs{border-top:var(--stroke-2) solid var(--ink-3);margin-top:26px}
  .job{display:grid;grid-template-columns:1.7fr .8fr .9fr auto;gap:var(--sp-4);align-items:center;padding:20px var(--sp-1);border-bottom:var(--stroke-2) solid var(--ink-3);text-decoration:none;transition:background .12s}
