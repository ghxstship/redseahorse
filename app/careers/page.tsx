...
<section className="pad"><div className="wrap">
  ...
  <div className="jobs"><Link href="/role" className="job"><h3>Production Manager</h3><span className="m">Production</span><span className="m loc">Miami, FL</span><span className="go">Full-time &#8599;</span></Link><Link href="/role" className="job"><h3>Project Coordinator</h3><span className="m">Project</span><span className="m loc">Las Vegas, NV</span><span className="go">Full-time &#8599;</span></Link><Link href="/role" className="job"><h3>Logistics Manager</h3><span className="m">Operations</span><span className="m loc">Miami, FL</span><span className="go">Full-time &#8599;</span></Link><Link href="/role" className="job"><h3>Technical Director</h3><span className="m">Production</span><span className="m loc">Los Angeles, CA</span><span className="go">Full-time &#8599;</span></Link><Link href="/role" className="job"><h3>Production Crew</h3><span className="m">Production</span><span className="m loc">Multiple</span><span className="go">Freelance &#8599;</span></Link><Link href="/role" className="job"><h3>Production Assistant</h3><span className="m">Support</span><span className="m loc">Miami, FL</span><span className="go">Internship &#8599;</span></Link><Link href="/role" className="job"><h3>Operations Director</h3><span className="m">Operations</span><span className="m loc">New York, NY</span><span className="go">Full-time &#8599;</span></Link><Link href="/role" className="job"><h3>Hospitality Manager</h3><span className="m">Hospitality</span><span className="m loc">Miami, FL</span><span className="go">Full-time &#8599;</span></Link></div>
  <p className="lede" style={{marginTop: '24px'}}>Don&rsquo;t see your role? <Link href="/apply" style={{color: 'var(--brass)', textDecoration: 'none'}}>Send a general application &#8599;</Link></p>
</div></section>
<section className="cta"><div className="wrap"><h2>Learn the Ropes.</h2><div className="row"><Link href="/apply" className="gx-btn gx-btn--lg">Apply Now</Link><Link href="/team" className="gx-btn gx-btn--ghost gx-btn--lg">Meet the Crew</Link></div></div></section></main><footer className="site-foot"><div className="wrap">
