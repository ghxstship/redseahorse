...
<section className="pad"><div className="wrap">
  ...
  <a className="bp" href="#"><p className="cat">Press</p><h3>GHXSTSHIP Breaks Ground on New Immersive Work in Miami</h3><p>A look at the newest build on the board and the crew behind it.</p><p className="d">Apr 2026</p></a>
...
<section className="cta"><div className="wrap"><h2>Build With<br/>GHXSTSHIP.</h2><div className="row"><Link href="/contact" className="gx-btn gx-btn--lg">Start a Project</Link><Link href="/solutions" className="gx-btn gx-btn--ghost gx-btn--lg">See the Fleet</Link></div></div></section>
</main>
