...
export default function Page() {
  ...
  .art-body > p.lead { font-size: clamp(19px, 18px + 0.15vw, 21px); line-height: 1.6; color: var(--color-text); font-weight: 600; }
...
<div className="wrap"><div className="art-body">
  ...
  <p>The one-producer model puts all of it under one roof. GHXSTSHIP runs four services — Experiential Design &amp; Production, Venue &amp; Site Operations, Tour &amp; Talent Management, and Technology &amp; Systems Implementation — with one accountable crew and one nine-phase production lifecycle — the XPMS 2.6 standard, Discover to Close.</p>
