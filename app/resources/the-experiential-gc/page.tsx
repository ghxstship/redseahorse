...
export default function Page() {
  ...
  .prose{max-width:760px;margin:0 auto;padding:48px 0 0}
  .prose .meta{font-family:var(--font-mono);font-size:11px;letter-spacing:.1em;text-transform:uppercase;color:var(--fg-on-dark-3);margin:0 0 26px}
  .prose p{font-size:17px;line-height:1.72;color:var(--fg-on-dark-1);margin:0 0 20px}
  .prose h2{font-family:var(--font-display);font-weight:900;font-size:30px;text-transform:uppercase;letter-spacing:-.01em;margin:36px 0 14px;line-height:1}
  .prose .lead{font-size:21px;line-height:1.6;color:var(--bone);font-weight:500}/*__nf__*/
  header.nav{position:sticky;top:0;z-index:50;background:var(--void);border-bottom:var(--stroke-3) solid var(--ink-3)}
  .nav-inner{display:flex;align-items:center;justify-content:space-between;min-height:72px;padding:10px 0}
