...
export default function Page() {
  ...
  .gl-term dt { font-family: var(--font-heading); font-weight: var(--font-heading-weight); font-size: 18px; text-transform: uppercase; margin: 0 0 6px; }
  .gl-term dd { margin: 0; font-size: 14px; line-height: 1.65; color: color-mix(in srgb, var(--color-text) 72%, transparent); max-width: 68ch; }
  .gl-term .x { display: inline-block; margin-top: 8px; font-size: 11px; letter-spacing: 0.1em; text-transform: uppercase; font-weight: 600; color: color-mix(in srgb, var(--color-text) 55%, transparent); }
` }} />
