...
export default function Page() {
  ...
  *{box-sizing:border-box}
  ...
  .term h2{font-family:var(--font-display);font-weight:800;font-size:var(--fs-h2);text-transform:uppercase;letter-spacing:-.005em;margin:0 0 10px;color:var(--bone)}
  .term p{font-size:var(--fs-body);line-height:1.65;color:var(--fg-on-dark-2);margin:0;max-width:820px}
  .term .x{font-family:var(--font-mono);font-size:var(--fs-label);letter-spacing:.1em;text-transform:uppercase;color:var(--plasma);margin-top:10px;display:inline-block}
