...
const __html = `<style>
  *{box-sizing:border-box}
  ...
  .nf{min-height:58vh;display:grid;place-items:center;text-align:center;padding:60px 0}
  .nf img{width:120px;height:120px;image-rendering:pixelated;margin-bottom:24px}
  .nf .code{font-family:var(--font-mono);font-size:13px;letter-spacing:.3em;color:var(--brass);text-transform:uppercase}
  .nf .row{display:flex;gap:14px;justify-content:center;flex-wrap:wrap;margin-top:26px}
/*__nf__*/
  header.nav{position:sticky;top:0;z-index:50;background:var(--void);border-bottom:var(--stroke-3) solid var(--ink-3)}
  .nav-inner{display:flex;align-items:center;justify-content:space-between;min-height:72px;padding:10px 0}
...
<div class="wrap"><p class="crumbs"><a href="/">Home</a> / <span style="color:var(--brass)">Off the Map</span></p></div>
<main>
<section><div class="wrap"><div class="nf"><div>
  <img src="/assets/skull-bone.svg" alt="">
  <p class="code">Error 404 &middot; Off Course</p>
  <h1 style="margin:14px 0 14px">Off the Map.</h1>
  <p class="lede" style="margin:0 auto;max-width:540px">This voyage isn't on the board. The page you're after has been struck, moved, or never set sail. Chart a new course below.</p>
  <div class="row"><a class="gx-btn gx-btn--lg" href="/">Back to Home Port</a><a class="gx-btn gx-btn--ghost gx-btn--lg" href="/work">See the Archives</a></div>
</div></div></div></section>
</main>
