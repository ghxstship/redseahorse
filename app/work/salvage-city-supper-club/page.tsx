...
export default function Page() {
  ...
  *{box-sizing:border-box}
  ...
  .nav-inner{display:flex;align-items:center;justify-content:space-between;min-height:72px;padding:10px var(--sp-6)}
  ...
  .meta{display:flex;gap:22px;flex-wrap:wrap;font-family:var(--font-mono);font-size:var(--fs-label);letter-spacing:.06em;text-transform:uppercase;color:var(--fg-on-dark-3);margin-bottom:26px}
  .meta b{color:var(--bone)}
  .coverimg{height:300px;border:var(--stroke-3) solid var(--ink);border-radius:var(--r-2);background:repeating-linear-gradient(45deg,var(--ink-2) 0 18px,var(--ink) 18px 36px);position:relative;display:grid;place-items:center;margin-bottom:50px}
  .coverimg i{font-size:64px;color:var(--brass)}
  .coverimg .ph{position:absolute;left:var(--sp-4);bottom:14px;font-family:var(--font-mono);font-size:var(--fs-label);letter-spacing:.1em;text-transform:uppercase;color:var(--fg-on-dark-3)}
  ...
  .block p{font-size:var(--fs-body-l);line-height:1.7;color:var(--fg-on-dark-2);margin:0 0 14px;max-width:820px}
  .block p strong{color:var(--bone)}
  .pull{font-family:var(--font-display);font-weight:800;font-size:var(--fs-h2);line-height:1.1;text-transform:uppercase;color:var(--bone);border-left:var(--stroke-4) solid var(--brass);padding-left:20px;margin:var(--sp-5) 0}
  .cta{padding:var(--sp-8) 0;text-align:center;border-top:var(--stroke-3) solid var(--brass);background:var(--ink)}
  .cta h3{font-family:var(--font-display);font-weight:900;font-size:var(--fs-h1);text-transform:uppercase;margin:0 0 18px}
  footer{padding:34px 0;text-align:center;font-family:var(--font-mono);font-size:var(--fs-label);letter-spacing:.1em;text-transform:uppercase;color:var(--fg-on-dark-3)}
/*__nf__*/
