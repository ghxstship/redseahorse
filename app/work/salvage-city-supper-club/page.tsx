...
export default function Page() {
  ...
  *{box-sizing:border-box}
  ...
  h1{font-family:var(--font-display);font-weight:900;font-size:clamp(40px,7vw,76px);line-height:0.97;text-transform:uppercase;letter-spacing:-.01em;margin:0 0 var(--sp-4)}
