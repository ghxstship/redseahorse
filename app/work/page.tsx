...
<section className="wrap sec-pad-sm">
  <div className="grid3 work-grid">
    <Link href="/work/salvage-city-supper-club" className="wcard">
      <figure className="media grayscale"><img src="https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=800&q=80&auto=format&fit=crop" alt="Supper club table set for service" width="800" height="600"/></figure>
    ...
    <article className="wcard">
      ...
      <div className="body"><span className="tag tag-neutral">Technology Implementation</span><h2>L-Acoustics DJ</h2><p className="meta">III Points Miami · 2025</p></div>
    </article>
    <article className="wcard">
