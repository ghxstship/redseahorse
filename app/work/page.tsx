...
export default function Page() {
  ...
  *{box-sizing:border-box}
  ...
  h1{font-family:var(--font-display);font-weight:900;font-size:clamp(44px,7.5vw,88px);line-height:0.97;text-transform:uppercase;letter-spacing:-.015em;margin:0 0 var(--space-18)}
  ...
  h2.sec{font-family:var(--font-display);font-weight:900;font-size:clamp(32px,4.4vw,52px);line-height:0.98;text-transform:uppercase;letter-spacing:-.01em;margin:0 0 var(--space-14)}
  ...
  .cta h2{font-family:var(--font-display);font-weight:900;font-size:clamp(40px,7vw,84px);line-height:0.96;text-transform:uppercase;margin:0 0 var(--space-22);position:relative}
  ...
  .wgrid{display:grid;grid-template-columns:repeat(3,1fr);gap:var(--space-18);padding:var(--sp-7) 0 0}
  ...
  .wc .body{padding:var(--space-18)}
  .wc h3{font-family:var(--font-display);font-weight:900;font-size:var(--fs-h3);text-transform:uppercase;margin:0 0 var(--space-6);line-height:1}
...
<section className="pad"><div className="wrap">
  ...
  <a className="wc" href="#" aria-disabled="true"><div className="media"><img src="https://images.unsplash.com/photo-1459749411175-04bf5292ceea?w=800&q=80&auto=format&fit=crop" alt="Factory Town" loading="lazy"/></div><div className="body"><h3>Factory Town</h3><p className="meta">Venue Management &middot; Miami &middot; 2023</p></div></a>
