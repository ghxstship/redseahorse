...
<section className="wrap sec-pad-sm">
  <div className="grid3 work-grid">
    <Link href="/work/salvage-city-supper-club" className="wcard">
      ...
      <div className="body"><span className="tag tag-neutral">Immersive</span><h2>Salvage City Supper Club</h2><p className="meta">Club Space Miami · 2025</p><span className="go">Read the case study →</span></div>
    </Link>
    <article className="wcard">
      ...
      <div className="body"><span className="tag tag-neutral">Festival</span><h2>EDC Las Vegas</h2><p className="meta">Insomniac, Las Vegas · 2025–26</p></div>
    </article>
    <article className="wcard">
    ...
    <article className="wcard">
      ...
      <div className="body"><span className="tag tag-neutral">Brand Activation</span><h2>Polymarket Grocery Store</h2><p className="meta">2026</p></div>
    </article>
    <article className="wcard">
    ...
    <article className="wcard">
      ...
      <div className="body"><span className="tag tag-neutral">Sporting Events</span><h2>Heineken Turn 4 Nightclub</h2><p className="meta">F1 Las Vegas · 2024</p></div>
    </article>
    <article className="wcard">
      ...
      <div className="body"><span className="tag tag-neutral">Sporting Events</span><h2>Formula 1 Las Vegas Grand Prix</h2><p className="meta">Las Vegas · 2023</p></div>
    </article>
    <article className="wcard">
    ...
    <article className="wcard">
      ...
      <div className="body"><span className="tag tag-neutral">Brand Activation</span><h2>Red Bull Unforeseen Motel</h2><p className="meta">III Points Miami · 2023</p></div>
    </article>
  </div>
</section>
