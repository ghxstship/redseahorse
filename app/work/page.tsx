...
<section className="wrap" style={{paddingBlock: 'clamp(36px,5vw,64px) 0'}}>
  ...
  <p className="lede">These are our case studies: shows we designed, built, crewed, and ran end to end across every industry we work — festivals, concerts and tours, brand activations, immersive experiences, premium hospitality, technology engineering, auto and motorsports, and sporting events. The numbers here are the ones that actually moved.</p>
...
<section className="wrap sec-pad-sm">
  <div className="grid3 work-grid">
    <article className="wcard">
      ...
      <div className="body"><span className="tag tag-neutral">Technology Engineering</span><h2>L-Acoustics DJ</h2><p className="meta">III Points Miami · 2025–present</p></div>
    </article>
    <article className="wcard">
