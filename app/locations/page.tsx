...
<section className="wrap" style={{paddingBlock: 'clamp(36px,5vw,64px) 0'}}>
  ...
  <p className="lede">GHXSTSHIP produces experiential events nationwide from eight locations. The Miami headquarters and three regional offices carry full production, operations, and technology teams. Four satellite offices put crew and coverage in the markets that run hot. Someone local in the room, the same standard everywhere.</p>
...
<section className="wrap sec-pad" style={{paddingTop: 'clamp(28px,4vw,48px)'}}>
  ...
  <div className="grid2" style={{marginTop: 'clamp(24px,3vw,36px)'}}>
    ...
    <article className="loc"><span className="tag tag-outline">Regional Office</span><h2>Los Angeles</h2><p>Our West Coast crew, entertainment, product launches, TV, film &amp; broadcast, and motorsports production.</p><p className="area">Serving LA · West Coast US</p></article>
    <article className="loc"><span className="tag tag-outline">Regional Office</span><h2>New York City</h2><p>Our Northeast crew, producing brand activations, launches, and immersive experiences across the country's most demanding event market.</p><p className="area">Serving NYC · Northeast US</p></article>
  </div>
</section>
