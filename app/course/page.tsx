...
export const metadata: Metadata = {
  title: "The Course",
  description: "The GHXSTSHIP Course is the nine-phase XPMS 2.5 experiential production lifecycle \u2014 Discover, Design, Advance, Procure, Build, Install, Operate, Amplify, and Close \u2014 the same nine gated phases every build runs, from the first conversation to archive handover.",
  keywords: ["production lifecycle", "XPMS 2.5", "nine-phase production lifecycle", "event production process", "experiential production phases", "production management methodology", "live event production planning"],
...
export default function Page() {
  ...
  .ph .phmeta { display: flex; gap: 10px; flex-wrap: wrap; margin: 0 0 10px; font-size: 11px; letter-spacing: 0.1em; text-transform: uppercase; font-weight: 600; color: color-mix(in srgb, var(--color-text) 55%, transparent); }
  .ph .phmeta b { color: var(--color-accent-700); }
  .ph .exit { margin-top: 12px; font-size: 13px; line-height: 1.6; max-width: 62ch; color: color-mix(in srgb, var(--color-text) 65%, transparent); }
...
<section className="wrap" style={{paddingBlock: 'clamp(36px,5vw,64px) 0'}}>
  ...
  <p className="lede">The Course is the GHXSTSHIP production lifecycle — the nine gated phases of the XPMS 2.5 standard that take an experiential or entertainment project from the first consultation to archive handover. Every build runs the same nine phases in three acts — Depart, Sail, Return — with clear deliverables, a gate to clear, and one accountable owner at each, so the budget and the schedule never go quiet on you between Discover and Close.</p>
...
<section className="band"><div className="wrap sec-pad">
  ...
  <div style={{marginTop: '28px'}}>
    <article className="ph" id="phase-1">
      ...
      <div>
        <h3>Discover</h3>
        <p className="phmeta"><span>Gate 1</span><b>DIS</b><span>Act I · Depart</span></p>
    ...
    <article className="ph" id="phase-2">
      ...
      <div>
        <h3>Design</h3>
        <p className="phmeta"><span>Gate 2</span><b>DSN</b><span>Act I · Depart</span></p>
    ...
    <article className="ph" id="phase-3">
      ...
      <div>
        <h3>Advance</h3>
        <p className="phmeta"><span>Gate 3</span><b>ADV</b><span>Act I · Depart</span></p>
    ...
    <article className="ph" id="phase-4">
      ...
      <div>
        <h3>Procure</h3>
        <p className="phmeta"><span>Gate 4</span><b>PRC</b><span>Act II · Sail</span></p>
    ...
    <article className="ph" id="phase-5">
      ...
      <div>
        <h3>Build</h3>
        <p className="phmeta"><span>Gate 5</span><b>BLD</b><span>Act II · Sail</span></p>
    ...
    <article className="ph" id="phase-6">
      ...
      <div>
        <h3>Install</h3>
        <p className="phmeta"><span>Gate 6</span><b>INS</b><span>Act II · Sail</span></p>
    ...
    <article className="ph" id="phase-7">
      ...
      <div>
        <h3>Operate</h3>
        <p className="phmeta"><span>Gate 7</span><b>OPR</b><span>Act III · Return</span></p>
    ...
    <article className="ph" id="phase-8">
      ...
      <div>
        <h3>Amplify</h3>
        <p className="phmeta"><span>Gate 8</span><b>AMP</b><span>Act III · Return</span></p>
    ...
    <article className="ph" id="phase-9">
      ...
      <div>
        <h3>Close</h3>
        <p className="phmeta"><span>Gate 9</span><b>CLS</b><span>Act III · Return</span></p>
...
<section className="wrap sec-pad">
  ...
  <div style={{marginTop: '20px', borderTop: '1px solid var(--color-divider)', maxWidth: '880px'}}>
    <details className="faq-item">
      ...
      <div className="faq-a">Nine. The Course follows the XPMS 2.5 standard — nine gated phases in three acts: Depart (Discover, Design, Advance), Sail (Procure, Build, Install), and Return (Operate, Amplify, Close). Strike lives inside Operate, and every work item resolves to one of 90 coordinates on the ATLVS Coordinate Matrix — ten department classes across the nine phases.</div>
    </details>
    <details className="faq-item">
      <summary className="faq-q">Can GHXSTSHIP act as the general contractor for an experiential or entertainment project?</summary>
      <div className="faq-a">Yes. GHXSTSHIP operates as the general contractor and accountable management team for experiential and entertainment production, owning scope, schedule, budget, crew, vendors, and technology across all nine phases of the XPMS 2.5 lifecycle.</div>
    </details>
    <details className="faq-item">
    ...
    <details className="faq-item">
      ...
      <div className="faq-a">Yes. We implement and integrate event technology: ATLVS, COMPVSS, GVTEWAY, and LEG3ND, plus third-party integrations, on-site installs, data, and analytics.</div>
    </details>
  </div>
</section>
...
<section className="band-dark close-cta"><div className="wrap">
  ...
  <div className="cta-row" style={{justifyContent: 'center', marginTop: '22px'}}>
    ...
    <Link href="/services/experiential-design-production" className="btn btn-secondary btn-lg">Explore the Services</Link>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: `{"@context":"https://schema.org","@type":"Service","serviceType":"Technology and systems implementation","name":"Technology and Systems Implementation","provider":{"@type":"Organization","name":"GHXSTSHIP"},"areaServed":"Worldwide","description":"Technology and systems implementation — ATLVS, COMPVSS, GVTEWAY, and LEG3ND plus show systems, integrations, data, and analytics."}` }} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: `{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"How many phases are in the GHXSTSHIP production lifecycle?","acceptedAnswer":{"@type":"Answer","text":"Nine. The Course follows the XPMS 2.5 standard — nine gated phases in three acts: Depart (Discover, Design, Advance), Sail (Procure, Build, Install), and Return (Operate, Amplify, Close). Strike lives inside Operate, and every work item resolves to one of 90 coordinates on the ATLVS Coordinate Matrix — ten department classes across the nine phases."}},{"@type":"Question","name":"Can GHXSTSHIP act as the general contractor for an experiential or entertainment project?","acceptedAnswer":{"@type":"Answer","text":"Yes. GHXSTSHIP operates as the general contractor and accountable management team for experiential and entertainment production, owning scope, schedule, budget, crew, vendors, and technology across all nine phases of the XPMS 2.5 lifecycle."}},{"@type":"Question","name":"Do you provide operations leadership?","acceptedAnswer":{"@type":"Answer","text":"Yes. We provide venue and site operations leadership: logistics, workforce and crew management, vendor coordination, health, safety and compliance, programming, and day-of operations."}},{"@type":"Question","name":"Do you handle event technology integrations and installs?","acceptedAnswer":{"@type":"Answer","text":"Yes. We implement and integrate event technology: ATLVS, COMPVSS, GVTEWAY, and LEG3ND, plus third-party integrations, on-site installs, data, and analytics."}}]}` }} />
    </>
  );
}
