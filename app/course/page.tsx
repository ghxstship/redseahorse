...
export const metadata: Metadata = {
  ...
  description: "The GHXSTSHIP Course is an eight-phase experiential production lifecycle \u2014 Project Discovery, R&amp;D, Creative Design, Compliance &amp; Risk, Production &amp; Build, Operations &amp; Logistics, Live Activation, and Strike &amp; Post \u2014 the same eight phases every build runs, from the first conversation to load-out.",
...
<section className="hero"><div className="wrap">
  ...
  <h1>8 Phases, from<br/>First Call to <span className="pop">Load-Out.</span></h1>
  <p className="answer">The Course is the GHXSTSHIP production lifecycle — eight phases that take an experiential or entertainment project from the first consultation to strike. Every build runs the same eight phases, with clear deliverables and one accountable owner at each, so the budget and the schedule never go quiet on you between discovery and close.</p>
