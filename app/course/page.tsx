...
<section className="wrap sec-pad">
  ...
  <div style={{marginTop: '20px', borderTop: '1px solid var(--color-divider)', maxWidth: '880px'}}>
    ...
    <details className="faq-item">
      ...
      <div className="faq-a">Yes. GHXSTSHIP operates as the lead producer and accountable management team for experiential and entertainment production, owning scope, schedule, budget, crew, vendors, and technology across all nine phases of the XPMS 2.5 lifecycle.</div>
    </details>
    <details className="faq-item">
