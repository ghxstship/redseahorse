...
<section className="hero"><div className="wrap">
  ...
  <p className="answer">The Course is the GHXSTSHIP production lifecycle — eight phases that take an experiential or entertainment project from the first consultation to strike. Every build runs the same eight phases, with clear deliverables and one accountable owner at each, so scope, schedule, and budget never go quiet on you between discovery and close.</p>
