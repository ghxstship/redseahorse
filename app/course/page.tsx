...
<section className="band-dark close-cta"><div className="wrap">
  ...
  <div className="cta-row" style={{justifyContent: 'center', marginTop: '22px'}}>
    ...
    <Link href="/services/experiential-design-production" className="btn btn-secondary btn-lg">Explore the Services</Link>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: `{"@context":"https://schema.org","@type":"Service","serviceType":"Technology and systems implementation","name":"Technology and Systems Implementation","provider":{"@type":"Organization","name":"GHXSTSHIP"},"areaServed":"Worldwide","description":"Technology and systems implementation — the ATLVS operator console, COMPVSS site and venue operations, the GVTEWAY public interface and marketplace, and the LEG3ND knowledge layer, plus the show technology we specify and install, third-party integrations, data, and analytics."}` }} />
