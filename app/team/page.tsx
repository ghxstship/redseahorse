...
<section className="wrap sec-pad" style={{paddingTop: '0'}}>
  ...
  <div className="grid4">
    ...
    <Link href="/careers" className="tm is-open"><figure className="av"><span className="open-mark">Open Role</span></figure><div className="body"><p className="role">Operations</p><h3>Operations Director</h3><p>Runs the day-of: logistics, crew, safety, and compliance.</p><span className="more">View the listing →</span></div></Link>
  ...
  <div className="grid4">
    ...
    <Link href="/careers" className="tm is-open"><figure className="av"><span className="open-mark">Open Role</span></figure><div className="body"><p className="role">Production</p><h3>Production Manager</h3><p>Runs the floor build and the technical package on site.</p><span className="more">View the listing →</span></div></Link>
    <Link href="/careers" className="tm is-open"><figure className="av"><span className="open-mark">Open Role</span></figure><div className="body"><p className="role">Operations</p><h3>Logistics Manager</h3><p>Moves freight and crew: load-in and out, transport, and vendors.</p><span className="more">View the listing →</span></div></Link>
    <Link href="/careers" className="tm is-open"><figure className="av"><span className="open-mark">Open Role</span></figure><div className="body"><p className="role">Support</p><h3>Project Coordinator</h3><p>Keeps the plan moving: documents, comms, and tracking.</p><span className="more">View the listing →</span></div></Link>
  </div>
  ...
  <div className="grid4">
    ...
    <Link href="/careers" className="tm is-open"><figure className="av"><span className="open-mark">Open Role</span></figure><div className="body"><p className="role">Production</p><h3>Production Crew</h3><p>The hands that build, rig, run, and strike.</p><span className="more">View the listing →</span></div></Link>
    ...
    <Link href="/careers" className="tm is-open"><figure className="av"><span className="open-mark">Open Role</span></figure><div className="body"><p className="role">Support</p><h3>Production Assistant</h3><p>Supports every department, and learns the ropes.</p><span className="more">View the listing →</span></div></Link>
  </div>
</section>
