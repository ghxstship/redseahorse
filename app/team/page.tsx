...
export default function Page() {
  ...
  .tm .body{padding:18px}.tm .rk{font-family:var(--font-mono);font-size:var(--fs-label);letter-spacing:.12em;text-transform:uppercase;color:var(--brass)}
  .tm h3{font-family:var(--font-display);font-weight:900;font-size:var(--fs-h3);text-transform:uppercase;margin:6px 0 6px;line-height:1}
  ...
  .tier{font-family:var(--font-mono);font-size:var(--fs-label);letter-spacing:.16em;text-transform:uppercase;color:var(--nebula);margin:34px 0 14px;display:flex;align-items:center;gap:10px}
...
<section className="pad alt"><div className="wrap">
  ...
  <div style={{display: 'flex', gap: '14px', marginTop: 'var(--sp-5)'}}><Link href="/careers" className="gx-btn">Join the Crew</Link><Link href="/solutions" className="gx-btn gx-btn--ghost">See What We Run</Link></div>
</div></section>
