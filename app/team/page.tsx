...
export default function Page() {
  ...
  h1{font-family:var(--font-display);font-weight:900;font-size:clamp(40px,7vw,84px);line-height:0.97;text-transform:uppercase;letter-spacing:-.015em;margin:0 0 var(--space-18)}
...
<section className="hero"><div className="wrap">
  ...
  <p className="answer">Every build is led by a senior crew that stays with you from the first consultation to strike. Ranks map to roles, so you always know who's accountable for your production, operations, and technology. Headshots and full bios drop in as the roster is confirmed.</p>
</div></section>
...
<section className="pad alt"><div className="wrap">
  ...
  <p className="answer">We train the next generation of experiential producers &mdash; no experience gatekept. Apprentice on real productions, next to the people who&rsquo;ve built them. Bring the hunger; we&rsquo;ll teach the ropes.</p>
