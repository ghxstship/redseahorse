...
<section className="band"><div className="wrap sec-pad" id="work">
  ...
  <div className="grid3" style={{marginTop: '28px'}}>
    <Link href="/work" className="wcard"><figure className="media grayscale"><img src="https://images.unsplash.com/photo-1470229722913-7c0e2dbbafd3?w=700&q=80&auto=format&fit=crop" alt="Black Coffee at the Race Track" loading="lazy" width="700" height="525"/></figure><div className="body"><h3>Black Coffee at the Race Track</h3><p className="meta">Concert &amp; Tour Production · Club Space Miami · 2026</p></div></Link>
