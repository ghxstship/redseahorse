...
<section className="band"><div className="wrap sec-pad" id="work">
  ...
  <div className="grid3" style={{marginTop: '28px'}}>
    ...
    <Link href="/work" className="wcard"><figure className="media grayscale"><img src="https://images.unsplash.com/photo-1542838132-92c53300491e?w=700&q=80&auto=format&fit=crop" alt="Produce aisle stocked in a grocery store" loading="lazy" width="700" height="525"/></figure><div className="body"><h3>The Polymarket</h3><p className="meta">Brand Activation · New York City · 2026</p></div></Link>
