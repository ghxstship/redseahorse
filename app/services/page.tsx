...
export default function Page() {
  ...
  .xlink h3 { font-size: 1.2rem; margin: 0; }
  .xlink p { font-size: 0.867rem; line-height: 1.6; color: color-mix(in srgb, var(--color-text) 72%, transparent); margin: 0; flex: none; }
...
<section className="wrap" style={{paddingBlock: 'clamp(36px,5vw,64px) 0'}}>
  ...
  <p className="lede">GHXSTSHIP is the management team behind the build. One crew across experiential design &amp; production, venue &amp; site operations, tour &amp; talent management, and technology &amp; systems engineering. We own scope, schedule, budget, crew, and the platforms from the first line to the night it opens, so you're talking to one team instead of refereeing six vendors.</p>
...
<section className="wrap sec-pad" style={{paddingTop: 'clamp(28px,4vw,48px)'}}>
  ...
  <div className="grid4" style={{marginTop: '28px'}}>
    ...
    <article className="svc-card"><div className="bar"></div><p className="role">The Production OS</p><h3>Technology &amp; Systems Engineering</h3><p>We give the team its instruments. ATLVS, COMPVSS, GVTEWAY &amp; LEG3ND, live and in build, plus the show tech we install, so the plan, the people, and the public side all live in one place.</p><Link href="/services/technology-systems-engineering" className="more">Explore the service →</Link></article>
  </div>
</section>
...
<section className="band"><div className="wrap sec-pad">
  ...
  <div className="grid3" style={{marginTop: '28px'}}>
    ...
    <div className="who-card"><h3>Brands, Promoters &amp; Producers</h3><p>Design, production, operations, and touring for festivals, tours, activations, immersive, cruise, parks, sporting, and broadcast, with the platforms to keep all of it in one place.</p></div>
  </div>
</div></section>
...
<section className="band"><div className="wrap sec-pad">
  ...
  <div className="grid3" style={{marginTop: '28px'}}>
    <Link href="/destinations" className="xlink"><h3>Industries</h3><p>Festivals, concerts and tours, brand activations, immersive experiences, cruise ships, amusement parks, sporting events, and TV, film and broadcast. See where the work happens.</p><span className="more">See the industries →</span></Link>
    ...
    <Link href="/platforms" className="xlink"><h3>Platforms</h3><p>ATLVS, COMPVSS, GVTEWAY, and LEG3ND, the four in-house platforms behind every engagement, some live today and some in build.</p><span className="more">See the platforms →</span></Link>
  </div>
</div></section>
...
<section className="wrap sec-pad">
  ...
  <div style={{marginTop: '20px', borderTop: '1px solid var(--color-divider)'}}>
    ...
    <details className="faq-item"><summary className="faq-q">Do you implement technology and systems?</summary><div className="faq-a">Yes. Technology &amp; Systems Engineering covers our four in-house platforms, the ATLVS operator console, COMPVSS for site and venue operations, the GVTEWAY public interface and marketplace, and the LEG3ND knowledge layer, some live today and some in build, plus the show systems we specify and install, third-party integrations, on-site installs, data, analytics, and the implementation and training to make it stick.</div></details>
    <details className="faq-item"><summary className="faq-q">Which industries and verticals do you serve?</summary><div className="faq-a">Festivals, concerts and tours, brand activations, immersive experiences, cruise ships, amusement parks, sporting events, TV, film and broadcast, premium hospitality, luxury retail, health and wellness, auto and motorsports, corporate and private, and philanthropy, for brands, promoters, venue operators, general contractors, and production directors worldwide.</div></details>
  </div>
</section>
