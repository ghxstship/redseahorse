...
<section className="band"><div className="wrap sec-pad"><div className="split2">
  ...
  <div>
    ...
    <p className="lede">XPMS 2.6 maps every deliverable to a department class and a production phase. Technology &amp; systems implementation lights up three, and carries the work from configuration to commissioning to the crew knowing how to use it.</p>
