...
export const metadata: Metadata = {
  ...
  description: "GHXSTSHIP Technology &amp; Systems Implementation delivers the four in-house platforms \u2014 ATLVS the operator console, COMPVSS site and venue operations, GVTEWAY the public interface and marketplace, LEG3ND the knowledge layer \u2014 plus show technology, systems integration, and implementation and training.",
...
<section className="wrap sec-pad" style={{paddingTop: 'clamp(28px,4vw,48px)'}}>
  ...
  <p className="lede">The technology layer of XPMS 2.5 is four platforms a production runs on. Each owns a job, and they share one source of truth. COMPVSS and LEG3ND are live today, the GVTEWAY marketplace is open with ticketing and stakeholder portals in build, and ATLVS is in build with early access opening to production partners.</p>
