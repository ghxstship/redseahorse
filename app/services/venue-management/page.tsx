...
<section className="pad alt"><div className="wrap">
  ...
  <div className="caps">
    <div className="cap"><i className="ph-bold ph-calendar-check"></i><span className="cap-t"><b style={{color: 'var(--bone)'}}>Operations</b> — venue programming and booking calendar, facility operations, vendor management, settlement and reporting.</span></div>
    <div className="cap"><i className="ph-bold ph-wine"></i><span className="cap-t"><b style={{color: 'var(--bone)'}}>Hospitality</b> — F&amp;B, bars and catering, VIP and premium hospitality, front-of-house standards.</span></div>
    <div className="cap"><i className="ph-bold ph-ticket"></i><span className="cap-t"><b style={{color: 'var(--bone)'}}>Experience</b> — guest journey, box office and access on <span className="pn-gvteway">GVTEWAY</span>, the room as a designed experience.</span></div>
    <div className="cap"><i className="ph-bold ph-user-focus"></i><span className="cap-t"><b style={{color: 'var(--bone)'}}>Executive</b> — the accountable venue lead, P&amp;L and standards across every date.</span></div>
  </div>
</div></section>
...
<section className="pad" id="difference" aria-labelledby="diff-h"><div className="wrap">
  ...
  <div className="caps" style={{marginTop: 'var(--space-32)'}}>
    <div className="cap"><i className="ph-bold ph-user-focus"></i><span className="cap-t"><b style={{color: 'var(--bone)'}}>One accountable lead</b> who owns the P&amp;L and the standard on every show.</span></div>
    <div className="cap"><i className="ph-bold ph-compass-tool"></i><span className="cap-t">We run the room on the tech we build, with <span className="pn-gvteway">GVTEWAY</span> at the door.</span></div>
    <div className="cap"><i className="ph-bold ph-calendar-check"></i><span className="cap-t">Operations owns the calendar, so the room stays full and the settlement stays clean.</span></div>
  </div>
</div></section>
