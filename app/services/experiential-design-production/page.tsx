...
export default function Page() {
  ...
  .role-tag { font-size: 0.8rem; letter-spacing: 0.14em; text-transform: uppercase; font-weight: 600; color: color-mix(in srgb, var(--color-text) 55%, transparent); margin: 10px 0 0; }
...
<section className="wrap sec-pad">
  ...
  <div style={{marginTop: '20px'}}>
    ...
    <div className="row-line"><span className="row-title">We Build the Tech</span><span className="row-sub">ATLVS, COMPVSS, GVTEWAY &amp; LEG3ND, in-house, live and in build</span></div>
  </div>
</section>
...
<section className="band"><div className="wrap sec-pad">
  ...
  <div style={{marginTop: '20px', borderTop: '1px solid var(--color-divider)'}}>
    ...
    <details className="faq-item"><summary className="faq-q">How does XPMS work?</summary><div className="faq-a">XPMS 2.6 is our Experiential Production Management Standard: nine gated phases: Discover, Design, Advance, Procure, Build, Install, Operate, Amplify, and Close, crossed with the ATLVS Coordinate Matrix, where every work item resolves to one of 90 coordinates, ten department classes across nine phases. Every deliverable lives at one address, a class and a phase, so nothing falls between Creative finishing a render and Production cutting steel. The Coordinate Matrix is the ATLVS task lens, and ATLVS is in build.</div></details>
