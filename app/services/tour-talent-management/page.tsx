...
<section className="wrap sec-pad" style={{paddingTop: 'clamp(28px,4vw,48px)'}}><div className="split2">
  ...
  <div>
    ...
    <h2 style={{fontSize: 'clamp(28px,3.6vw,44px)'}}>The Whole Run, One Sheet.</h2>
...
<section className="band"><div className="wrap sec-pad">
  ...
  <h2 style={{fontSize: 'clamp(30px,4.2vw,48px)'}}>Nine Phases, Every City.</h2>
...
<section className="wrap sec-pad">
  ...
  <h2 style={{fontSize: 'clamp(30px,4.2vw,48px)'}}>Built for the People on the Bus.</h2>
...
<section className="wrap sec-pad">
  ...
  <h2 style={{fontSize: 'clamp(30px,4.2vw,48px)'}}>Tour &amp; Talent Management FAQ.</h2>
