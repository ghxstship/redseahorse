...
<div class="wrap"><p class="crumbs"><a href="/">Home</a> / <a href="/destinations">Destinations</a> / <span style="color:var(--brass)">Festival Production</span></p></div>

<main>
<section class="hero"><div class="wrap"><div class="hero-grid">
  <div class="hero-copy">
    <p class="eyebrow">Destinations · Festivals</p>
    <h1>Festival<br><span class="pop">Production</span></h1>
    <p class="answer">GHXSTSHIP is a full-service <strong>festival production company</strong> headquartered in
  ...
  <figure class="hero-fig"><img src="https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=900&q=80&auto=format&fit=crop" alt="Festival Production · Multi-Stage" loading="lazy"><figcaption>Festival Production · Multi-Stage</figcaption></figure>
</div></div></section>

<section class="pad alt"><div class="wrap">
  <p class="eyebrow">What We Build</p>
  <h2 class="sec">Everything a Festival Needs.</h2>
  <div class="caps">
    <div class="cap"><i class="ph-bold ph-blueprint"></i>Site design &amp; infrastructure</div>
    <div class="cap"><i class="ph-bold ph-cube"></i>Multi-stage design &amp; scenic build</div>
    <div class="cap"><i class="ph-bold ph-waveform"></i>Audio, lighting, video &amp; rigging</div>
    <div class="cap"><i class="ph-bold ph-lightning"></i>Power &amp; distribution</div>
    <div class="cap"><i class="ph-bold ph-star"></i>Headliner &amp; talent experiences</div>
    <div class="cap"><i class="ph-bold ph-shield-check"></i>Permits, safety &amp; compliance</div>
  </div>
</div></section>

<section class="pad"><div class="wrap">
  <p class="eyebrow">The Course</p>
  <h2 class="sec">Your Festival, Eight Phases.</h2>
  <p class="lede">Every festival sails the same proven course — from first consultation to load-out and analytics.</p>
...
<section class="pad alt"><div class="wrap">
  ...
  <h2 class="sec">Built for the People Who Build Festivals.</h2>
  <p class="answer">Festival production at GHXSTSHIP is built for the producers and partners accountable for
    the show.</p>
  <div class="aud">
    <span class="gx-tag">Festival Promoters</span><span class="gx-tag">Brands &amp; Sponsors</span>
    <span class="gx-tag">Talent Buyers</span><span class="gx-tag">Production Directors</span>
    <span class="gx-tag">Venue &amp; City Partners</span>
  </div>
</div></section>

<section class="pad"><div class="wrap">
  <p class="eyebrow">The Archives</p>
  <h2 class="sec">Festivals We've Charted.</h2>
  <div class="mu-grid"><article class="mu" style="grid-column:1/-1"><div class="body" style="text-align:center;padding:40px"><h3>Now Charting</h3><p class="meta" style="margin-top:8px">New festival work is on the board. Want to be the first case study? Start a project.</p><a class="gx-btn gx-btn--sm" style="margin-top:18px" href="mailto:hello@ghxstship.tours">Start a Project</a></div></article>
  </div>
</div></section>
...
<section class="pad alt faq"><div class="wrap">
  ...
  <h2 class="sec">Festival Production FAQ.</h2>
  <div class="faq-list">
    ...
    <details><summary>What does GHXSTSHIP do for festivals?<span class="ic">+</span></summary><p class="a">End-to-end festival production: site and infrastructure, multi-stage design and build, technical production (audio, lighting, video, rigging, power), and headliner experiences — managed through our eight-phase production lifecycle.</p></details>
    <details><summary>Who is festival production for?<span class="ic">+</span></summary><p class="a">Festival promoters, brands, talent buyers, and production directors who need one accountable partner from first consultation to load-out.</p></details>
    <details><summary>What size festivals can you produce?<span class="ic">+</span></summary><p class="a">From boutique single-stage events to 50,000-plus-capacity multi-stage festivals, with full infrastructure and logistics.</p></details>
  </div>
</div></section>

<section class="cta"><div class="wrap">
  <p class="eyebrow" style="justify-content:center">Ready When You Are</p>
  <h2>Chart Your<br>Festival.</h2>
...
const __jsonLd: string[] = [
  `{"@context":"https://schema.org","@type":"Service","name":"Festival Production","serviceType":"Festival production",
