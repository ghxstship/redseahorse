...
<section className="pad"><div className="wrap">
  ...
  <div className="mu-grid">
    <article className="mu"><div className="media" style={{background: 'radial-gradient(var(--nebula) 16%,transparent 17%) 0 0/18px 18px,var(--ink)'}}><span className="gx-chip-pixel px">RRR 226</span><i className="ph-bold ph-shopping-cart" style={{fontSize: '44px', color: 'var(--bone)'}}></i></div><div className="body"><h3>Polymarket Grocery Store</h3><p className="meta">Brand Activation · Miami · 2026</p></div></article>
    <article className="mu"><div className="media" style={{background: 'repeating-linear-gradient(45deg,#18262A 0 14px,#101A1B 14px 28px)'}}><span className="gx-chip-pixel px">RRR 311</span><i className="ph-bold ph-confetti" style={{fontSize: '44px', color: 'var(--brass)'}}></i></div><div className="body"><h3>Red Bull Unforeseen Motel</h3><p className="meta">Brand Activation · III Points · Miami · 2023</p></div></article>
  </div>
</div></section>
