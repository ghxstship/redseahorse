...
export default function Page() {
  ...
  *{box-sizing:border-box}
  ...
  .pad{padding:54px 0}
  .dgrid{display:grid;grid-template-columns:repeat(3,1fr);gap:18px;margin-top:var(--sp-2)}
  ...
  .dc h2{font-family:var(--font-display);font-weight:900;font-size:var(--fs-h2);text-transform:uppercase;margin:14px 0 var(--sp-2);line-height:.98}
  ...
  .more{margin-top:30px;padding-top:var(--sp-5);border-top:var(--stroke-2) solid var(--ink-3)}
  ...
  .tags span{font-family:var(--font-mono);font-size:var(--fs-label);letter-spacing:.06em;text-transform:uppercase;color:var(--fg-on-dark-2);border:var(--stroke-1) solid var(--ink-3);border-radius:var(--r-pill);padding:7px 13px}
