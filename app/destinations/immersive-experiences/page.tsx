...
<div className="wrap"><p className="crumbs"><Link href="/">Home</Link> / <Link href="/destinations">Destinations</Link> / <span style={{color: 'var(--brass)'}}>Immersive Experiences</span></p></div>

<main>
<section className="hero"><div className="wrap"><div className="hero-grid">
  <div className="hero-copy">
    <p className="eyebrow">Destinations · Immersive</p>
    <h1>Immersive<br/><span className="pop">Experiences</span></h1>
    <p className="answer">GHXSTSHIP is a full-service <strong>immersive experience design</strong> studio headquartered in Miami, with offices in Las Vegas, Chicago, New York, and Los Angeles. We build narrative installations and immersive worlds audiences step inside — for brands, museums, and cultural institutions — through our eight-phase production lifecycle.</p>
  ...
  <figure className="hero-fig"><img src="https://images.unsplash.com/photo-1459749411175-04bf5292ceea?w=900&q=80&auto=format&fit=crop" alt="Immersive Experience" loading="lazy"/><figcaption>Immersive Experience</figcaption></figure>
</div></div></section>

<section className="pad alt"><div className="wrap">
  <p className="eyebrow">What We Build</p>
  <h2 className="sec">Worlds Audiences Step Inside.</h2>
  <div className="caps">
    <div className="cap"><i className="ph-bold ph-book-open"></i>Narrative &amp; world-building</div>
    <div className="cap"><i className="ph-bold ph-cube"></i>Spatial &amp; set design</div>
    <div className="cap"><i className="ph-bold ph-cursor-click"></i>Interactive technology</div>
    <div className="cap"><i className="ph-bold ph-projector-screen"></i>Projection, audio &amp; lighting</div>
    <div className="cap"><i className="ph-bold ph-wrench"></i>Fabrication &amp; install</div>
    <div className="cap"><i className="ph-bold ph-path"></i>Operations &amp; run-of-show</div>
  </div>
</div></section>

<section className="pad"><div className="wrap">
  <p className="eyebrow">The Course</p>
  <h2 className="sec">Immersive, Eight Phases.</h2>
...
<section className="pad alt"><div className="wrap">
  ...
  <h2 className="sec">Built for Storytellers &amp; Institutions.</h2>
  <p className="answer">Immersive work at GHXSTSHIP is built for the teams shaping culture and brand worlds.</p>
  <div className="aud"><span className="gx-tag">Brands</span><span className="gx-tag">Museums</span><span className="gx-tag">Cultural Institutions</span><span className="gx-tag">Attractions</span><span className="gx-tag">Agencies</span></div>
</div></section>

<section className="pad"><div className="wrap">
  <p className="eyebrow">The Archives</p>
  <h2 className="sec">Worlds We Built.</h2>
  <div className="mu-grid">
    <article className="mu"><div className="media" style={{background: 'repeating-linear-gradient(45deg,var(--ink-2) 0 14px,var(--ink) 14px 28px)'}}><span className="gx-chip-pixel px">RRR 052</span><i className="ph-bold ph-confetti" style={{fontSize: 'var(--fs-h1)', color: 'var(--brass)'}}></i></div><div className="body"><h3>Salvage City Supper Club</h3><p className="meta">Immersive Experience · Club Space · Miami · 2025–26</p></div></article>
  </div>
</div></section>
...
<section className="pad alt faq"><div className="wrap">
  ...
  <h2 className="sec">Immersive FAQ.</h2>
  <div className="faq-list">
    ...
    <details><summary>What does GHXSTSHIP do for immersive experiences?<span className="ic">+</span></summary><p className="a">End-to-end immersive design: narrative and world-building, spatial and set design, interactive technology, projection and lighting, fabrication, and run-of-show — on our eight-phase lifecycle.</p></details>
    <details><summary>Who are immersive experiences for?<span className="ic">+</span></summary><p className="a">Brands, museums, cultural institutions, and attractions that want audiences to step inside a story.</p></details>
    <details><summary>Do you handle the technology and the build?<span className="ic">+</span></summary><p className="a">Yes — creative, technology, fabrication, install, and daily operations are all in-house.</p></details>
  </div>
</div></section>

<section className="cta"><div className="wrap">
  <p className="eyebrow" style={{justifyContent: 'center'}}>Ready When You Are</p>
  <h2>Build Your<br/>World.</h2>
  <div className="hero-cta" style={{justifyContent: 'center'}}>
    ...
    <Link href="/#work" className="gx-btn gx-btn--ghost gx-btn--lg">See the Archives</Link>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: `{"@context":"https://schema.org","@type":"Service","name":"Immersive Experiences","serviceType":"Immersive experience design","provider":{"@type":"Organization","name":"GHXSTSHIP","url":"https://ghxstship.tours/"},"areaServed":"Worldwide","description":"Narrative installations and immersive worlds audiences step inside, delivered through the GHXSTSHIP eight-phase production lifecycle.","audience":{"@type":"Audience","audienceType":"Brands, museums, and cultural institutions"},"url":"https://ghxstship.tours/destinations/immersive-experiences"}` }} />
 ...
 {"@type":"ListItem","position":3,"name":"Immersive Experiences","item":"https://ghxstship.tours/destinations/immersive-experiences"}
]}` }} />
 ...
 {"@type":"Question","name":"What does GHXSTSHIP do for immersive experiences?","acceptedAnswer":{"@type":"Answer","text":"End-to-end immersive design: narrative and world-building, spatial and set design, interactive technology, projection and lighting, fabrication, and run-of-show — on our eight-phase lifecycle."}},
