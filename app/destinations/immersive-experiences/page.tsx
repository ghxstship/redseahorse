...
<section className="pad alt"><div className="wrap">
  ...
  <div className="caps">
    <div className="cap"><i className="ph-bold ph-book-open"></i><span className="cap-t">Narrative &amp; world-building</span></div>
    <div className="cap"><i className="ph-bold ph-cube"></i><span className="cap-t">Spatial &amp; set design</span></div>
    <div className="cap"><i className="ph-bold ph-cursor-click"></i><span className="cap-t">Interactive technology</span></div>
    <div className="cap"><i className="ph-bold ph-projector-screen"></i><span className="cap-t">Projection, audio &amp; lighting</span></div>
    <div className="cap"><i className="ph-bold ph-wrench"></i><span className="cap-t">Fabrication &amp; install</span></div>
    <div className="cap"><i className="ph-bold ph-path"></i><span className="cap-t">Operations &amp; run-of-show</span></div>
  </div>
</div></section>
