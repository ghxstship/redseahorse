...
<section className="pad"><div className="wrap">
  ...
  <div className="mu-grid">
    <article className="mu"><div className="media" style={{background: 'repeating-linear-gradient(45deg,#18262A 0 14px,#101A1B 14px 28px)'}}><span className="gx-chip-pixel px">RRR 052</span><i className="ph-bold ph-confetti" style={{fontSize: '44px', color: 'var(--brass)'}}></i></div><div className="body"><h3>Salvage City Supper Club</h3><p className="meta">Immersive Experience · Club Space · Miami · 2025–26</p></div></article>
  </div>
</div></section>
