...
<section className="pad"><div className="wrap">
  ...
  <div className="mu-grid"><article className="mu" style={{gridColumn: '1/-1'}}><div className="body" style={{textAlign: 'center', padding: '40px'}}><h3>Now Charting</h3><p className="meta" style={{marginTop: 'var(--sp-2)'}}>New broadcast work is on the board. Want to be the first case study? Start a project.</p><a className="gx-btn gx-btn--sm" style={{marginTop: '18px'}} href="mailto:hello@ghxstship.tours">Start a Project</a></div></article>
  </div>
</div></section>
