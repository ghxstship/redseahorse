...
export const metadata: Metadata = {
  ...
  description: "GHXSTSHIP is a broadcast, film &amp; television production company in Miami \u2014 Las Vegas, Chicago, NY, LA for networks, studios, streamers &amp; brands \u2014 live broadcast, content capture &amp; on-air activations, via our 9-phase XPMS 2.5 lifecycle.",
...
<section className="wrap" style={{paddingBlock: 'clamp(36px,5vw,64px) clamp(40px,6vw,72px)'}}><div className="hero-grid">
  <div>
    ...
    <p className="lede">GHXSTSHIP is a full-service broadcast, film, and television production company headquartered in Miami, with offices in Las Vegas, Chicago, New York, and Los Angeles. We deliver live broadcast, content capture, and on-air activations — for networks, studios, streamers, and brands — through our nine-phase XPMS 2.5 production lifecycle.</p>
...
<section className="band"><div className="wrap sec-pad">
  ...
  <div className="grid4" style={{marginTop: '28px'}}>
    ...
    <article className="svc-card"><div className="bar"></div><p className="role">The Foreman</p><h3>Venue &amp; Site Operations</h3><p>Stage and location operations, staffing, safety, and vendor logistics on the clock.</p><Link href="/services/venue-site-operations" className="more">Explore the service →</Link></article>
    <article className="svc-card"><div className="bar"></div><p className="role">The Road Manager</p><h3>Tour &amp; Talent Management</h3><p>On-air talent, appearances, and artist logistics from call time to wrap.</p><Link href="/services/tour-talent-management" className="more">Explore the service →</Link></article>
    <article className="svc-card"><div className="bar"></div><p className="role">The Procore</p><h3>Technology &amp; Systems Implementation</h3><p>ATLVS, COMPVSS, GVTEWAY &amp; LEG3ND plus playback and control for the live moment.</p><Link href="/services/technology-systems-implementation" className="more">Explore the service →</Link></article>
  </div>
</div></section>
...
<section className="band-dark close-cta"><div className="wrap">
 ...
 {"@type":"Question","name":"What does GHXSTSHIP do for TV, film and broadcast?","acceptedAnswer":{"@type":"Answer","text":"End-to-end broadcast production: live broadcast, set design and scenic, camera, audio, and lighting, content capture and post, on-air activations, and compliance — on our nine-phase XPMS 2.5 lifecycle."}},
