...
<section className="pad alt"><div className="wrap">
  ...
  <div className="caps">
    <div className="cap"><i className="ph-bold ph-star"></i><span className="cap-t">Fan experience design</span></div>
    <div className="cap"><i className="ph-bold ph-flag-banner"></i><span className="cap-t">Field &amp; stadium activations</span></div>
    <div className="cap"><i className="ph-bold ph-video-camera"></i><span className="cap-t">Broadcast-ready staging</span></div>
    <div className="cap"><i className="ph-bold ph-waveform"></i><span className="cap-t">Audio, lighting &amp; video</span></div>
    <div className="cap"><i className="ph-bold ph-handshake"></i><span className="cap-t">Sponsorship integration</span></div>
    <div className="cap"><i className="ph-bold ph-shield-check"></i><span className="cap-t">Safety &amp; crowd ops</span></div>
  </div>
</div></section>
...
<section className="pad"><div className="wrap">
  ...
  <h2 className="sec">Game Days We Ran.</h2>
