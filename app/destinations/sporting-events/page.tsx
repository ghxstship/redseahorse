...
export const metadata: Metadata = {
  title: "Sporting Events \u2014 GHXSTSHIP",
...
<div class="wrap"><p class="crumbs"><a href="/">Home</a> / <a href="/destinations">Destinations</a> / <span style="color:var(--brass)">Sporting Events</span></p></div>

<main>
<section class="hero"><div class="wrap"><div class="hero-grid">
  <div class="hero-copy">
    <p class="eyebrow">Destinations · Sporting Events</p>
    <h1>Sporting<br><span class="pop">Events</span></h1>
    <p class="answer">GHXSTSHIP is a full-service <strong>sporting event production company</strong> headquartered in Miami, with offices in Las Vegas, Chicago, New York, and Los Angeles. We deliver stadium activations, fan experiences, and game-day production — for leagues, teams, brands, and venues — through our eight-phase production lifecycle.</p>
    <div class="hero-cta">
  ...
  <figure class="hero-fig"><img src="https://images.unsplash.com/photo-1431324155629-1a6deb1dec8d?w=900&q=80&auto=format&fit=crop" alt="Sporting Event Production" loading="lazy"><figcaption>Sporting Event Production</figcaption></figure>
</div></div></section>

<section class="pad alt"><div class="wrap">
  <p class="eyebrow">What We Build</p>
  <h2 class="sec">Game-Day, Handled.</h2>
  <div class="caps">
    <div class="cap"><i class="ph-bold ph-star"></i>Fan experience design</div>
    <div class="cap"><i class="ph-bold ph-flag-banner"></i>Field &amp; stadium activations</div>
    <div class="cap"><i class="ph-bold ph-video-camera"></i>Broadcast-ready staging</div>
    <div class="cap"><i class="ph-bold ph-waveform"></i>Audio, lighting &amp; video</div>
    <div class="cap"><i class="ph-bold ph-handshake"></i>Sponsorship integration</div>
    <div class="cap"><i class="ph-bold ph-shield-check"></i>Safety &amp; crowd ops</div>
  </div>
</div></section>

<section class="pad"><div class="wrap">
  <p class="eyebrow">The Course</p>
  <h2 class="sec">Sporting, Eight Phases.</h2>
...
<section class="pad alt"><div class="wrap">
  ...
  <h2 class="sec">Built for Leagues, Teams &amp; Venues.</h2>
  <p class="answer">Sporting production at GHXSTSHIP is built for the partners accountable for game day.</p>
  <div class="aud"><span class="gx-tag">Leagues</span><span class="gx-tag">Teams</span><span class="gx-tag">Venues</span><span class="gx-tag">Brands &amp; Sponsors</span><span class="gx-tag">Federations</span></div>
</div></section>

<section class="pad"><div class="wrap">
  <p class="eyebrow">The Archives</p>
  <h2 class="sec">Game Days, Charted.</h2>
  <div class="mu-grid">
    <article class="mu"><div class="media" style="background:repeating-linear-gradient(45deg,#18262A 0 14px,#101A1B 14px 28px)"><span class="gx-chip-pixel px">RRR 001</span><i class="ph-bold ph-flag-checkered" style="font-size:44px;color:var(--brass)"></i></div><div class="body"><h3>Formula 1 Las Vegas Grand Prix</h3><p class="meta">Motorsports · Las Vegas · 2023</p></div></article>
    <article class="mu"><div class="media" style="background:radial-gradient(var(--nebula) 16%,transparent 17%) 0 0/18px 18px,var(--ink)"><span class="gx-chip-pixel px">RRR 023</span><i class="ph-bold ph-trophy" style="font-size:44px;color:var(--bone)"></i></div><div class="body"><h3>Heineken Turn4 Nightclub</h3><p class="meta">Motorsports · F1 Las Vegas Grand Prix · 2024</p></div></article>
  </div>
</div></section>
...
<section class="pad alt faq"><div class="wrap">
  ...
  <div class="faq-list">
    ...
    <details><summary>What does GHXSTSHIP do for sporting events?<span class="ic">+</span></summary><p class="a">End-to-end sporting event production: fan experience design, field and stadium activations, broadcast-ready staging, technical production, sponsorship integration, and crowd operations — on our eight-phase lifecycle.</p></details>
    <details><summary>Who is sporting production for?<span class="ic">+</span></summary><p class="a">Leagues, teams, venues, federations, and brand sponsors who need a single accountable production partner.</p></details>
    <details><summary>Can you produce broadcast-ready moments?<span class="ic">+</span></summary><p class="a">Yes — staging and technical are built to broadcast standards for in-venue and on-air.</p></details>
  </div>
</div></section>
