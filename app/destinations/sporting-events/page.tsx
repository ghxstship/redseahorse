...
<section className="pad"><div className="wrap">
  ...
  <div className="mu-grid">
    <article className="mu"><div className="media" style={{background: 'repeating-linear-gradient(45deg,#18262A 0 14px,#101A1B 14px 28px)'}}><span className="gx-chip-pixel px">RRR 001</span><i className="ph-bold ph-flag-checkered" style={{fontSize: '44px', color: 'var(--brass)'}}></i></div><div className="body"><h3>Formula 1 Las Vegas Grand Prix</h3><p className="meta">Motorsports · Las Vegas · 2023</p></div></article>
    <article className="mu"><div className="media" style={{background: 'radial-gradient(var(--nebula) 16%,transparent 17%) 0 0/18px 18px,var(--ink)'}}><span className="gx-chip-pixel px">RRR 023</span><i className="ph-bold ph-trophy" style={{fontSize: '44px', color: 'var(--bone)'}}></i></div><div className="body"><h3>Heineken Turn4 Nightclub</h3><p className="meta">Motorsports · F1 Las Vegas Grand Prix · 2024</p></div></article>
  </div>
</div></section>
