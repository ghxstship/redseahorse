...
export const metadata: Metadata = {
  ...
  description: "GHXSTSHIP is a sporting event production company in Miami \u2014 Las Vegas, Chicago, NY, LA for leagues, teams, brands &amp; venues \u2014 stadium activations, fan experiences &amp; game-day production, via our 9-phase XPMS 2.5 lifecycle.",
...
<section className="wrap" style={{paddingBlock: 'clamp(36px,5vw,64px) clamp(40px,6vw,72px)'}}><div className="hero-grid">
  <div>
    ...
    <p className="lede">GHXSTSHIP is a full-service sporting event production company headquartered in Miami, with offices in Las Vegas, Chicago, New York, and Los Angeles. We deliver stadium activations, fan experiences, and game-day production — for leagues, teams, brands, and venues — through our nine-phase XPMS 2.5 production lifecycle.</p>
...
<section className="band"><div className="wrap sec-pad">
  ...
  <h2 style={{fontSize: 'clamp(30px,4.2vw,48px)'}}>Game-Day, Handled.</h2>
...
<section className="wrap sec-pad">
  ...
  <h2 style={{fontSize: 'clamp(30px,4.2vw,48px)'}}>Sporting, Nine Phases.</h2>
...
<section className="band"><div className="wrap sec-pad">
  ...
  <h2 style={{fontSize: 'clamp(30px,4.2vw,48px)'}}>Built for Leagues, Teams &amp; Venues.</h2>
...
<section className="wrap sec-pad">
  ...
  <h2 style={{fontSize: 'clamp(30px,4.2vw,48px)'}}>Game Days We Ran.</h2>
...
<section className="band"><div className="wrap sec-pad">
  ...
  <h2 style={{fontSize: 'clamp(30px,4.2vw,48px)'}}>Four Verticals Behind Every Game Day.</h2>
  ...
  <div className="grid4" style={{marginTop: '28px'}}>
    <article className="svc-card"><div className="bar"></div><p className="role">The General Contractor</p><h3>Experiential Design &amp; Production</h3><p>Fan experiences and activations designed, built, and finished end to end.</p><Link href="/services/experiential-design-production" className="more">Explore the service →</Link></article>
    <article className="svc-card"><div className="bar"></div><p className="role">The Foreman</p><h3>Venue &amp; Site Operations</h3><p>Stadium logistics, staffing, safety, and crowd operations at full capacity.</p><Link href="/services/venue-site-operations" className="more">Explore the service →</Link></article>
    <article className="svc-card"><div className="bar"></div><p className="role">The Road Manager</p><h3>Tour &amp; Talent Management</h3><p>Halftime acts, appearances, and talent logistics on the game-day clock.</p><Link href="/services/tour-talent-management" className="more">Explore the service →</Link></article>
...
<section className="band"><div className="wrap sec-pad">
  ...
  <h2 style={{fontSize: 'clamp(30px,4.2vw,48px)'}}>Sporting FAQ.</h2>
