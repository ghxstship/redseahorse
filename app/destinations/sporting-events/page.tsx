...
<section className="wrap" style={{paddingBlock: 'clamp(36px,5vw,64px) clamp(40px,6vw,72px)'}}><div className="hero-grid">
  <div>
    ...
    <p className="lede">GHXSTSHIP is a full-service sporting event production company headquartered in Miami, with primary offices in Chicago, Los Angeles, and New York City, and satellite offices in Nashville, Denver, Las Vegas, and Phoenix. We deliver stadium activations, fan experiences, and game-day production — for leagues, teams, brands, and venues — through our nine-phase XPMS 2.6 production lifecycle.</p>
