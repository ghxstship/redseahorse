...
<section className="wrap sec-pad" id="faq">
  ...
  <div className="faq-wrap" style={{marginTop: '20px'}}>
    ...
    <details className="faq-item">
      ...
      <div className="faq-a">Yes. We're headquartered in Miami with primary offices in Chicago, Los Angeles, and New York City, and satellite offices in Nashville, Denver, Las Vegas, and Phoenix, and we take work wherever the project is. Travel and per diem are line items in the proposal, not surprises on the invoice.</div>
    </details>
    <details className="faq-item">
