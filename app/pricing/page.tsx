...
export const metadata: Metadata = {
  ...
  keywords: ["event production pricing", "production company engagement models", "experiential production proposal", "event production management company", "production management services", "hire event production company"],
...
export default function Page() {
  ...
  .model-card .who { font-size: 0.867rem; line-height: 1.6; color: color-mix(in srgb, var(--color-text) 72%, transparent); margin: 0 0 14px; }
  .model-card .lbl { font-size: 0.733rem; letter-spacing: 0.12em; text-transform: uppercase; font-weight: 600; color: color-mix(in srgb, var(--color-text) 55%, transparent); margin: 14px 0 2px; }
  .model-card .row-line { padding: 10px 0; grid-template-columns: 1fr; }
  .model-card .row-line .row-title { font-size: 0.933rem; }
  .model-card .row-line .row-sub { font-size: 0.8rem; }
  .model-card .how { font-size: 0.867rem; line-height: 1.6; color: color-mix(in srgb, var(--color-text) 72%, transparent); margin: 0; flex: none; }
  ...
  .cmp-wrap .table tbody th[scope="row"] { font-family: var(--font-heading); font-weight: 600; font-size: 0.867rem; text-transform: uppercase; letter-spacing: 0.02em; color: var(--color-text); border-bottom: 1px solid var(--color-divider); }
...
<section className="wrap sec-pad" id="models">
  <div className="grid3">
    <article className="model-card">
      ...
      <p className="who">For festivals, tours, activations, and venues that want one accountable partner end to end. We act as the lead production partner: all four disciplines, all nine phases, one contract, one name on the hook.</p>
      ...
      <div className="row-line"><span className="row-title">The Platforms</span><span className="row-sub">ATLVS, COMPVSS, GVTEWAY &amp; LEG3ND, the live ones wired in from day one and the rest as they ship</span></div>
...
<section className="wrap sec-pad" id="faq">
  ...
  <div className="faq-wrap" style={{marginTop: '20px'}}>
    ...
    <details className="faq-item">
      ...
      <div className="faq-a">Yes. We're headquartered in Miami with regional offices in Los Angeles, Chicago, and New York City, and satellite offices in Nashville, Denver, Las Vegas, and Phoenix, and we take work wherever the project is. Travel and per diem are line items in the proposal, not surprises on the invoice.</div>
    </details>
    <details className="faq-item">
    ...
    <details className="faq-item">
      ...
      <div className="faq-a">Yes. As the lead producer we manage the vendors you already trust alongside the ones we bring, under one scope and one schedule. We don't require you to drop relationships that work, we require everyone to hit their dates.</div>
    </details>
  </div>
</section>
