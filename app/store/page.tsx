...
export default function Page() {
  ...
  *{box-sizing:border-box}
  ...
  .cart{display:flex;align-items:center;gap:7px;font-family:var(--font-mono);font-size:var(--fs-label);letter-spacing:.1em;text-transform:uppercase;color:var(--brass)}
  .cart .n{background:var(--brass);color:var(--on-brass);border-radius:var(--r-pill);min-width:20px;height:20px;display:grid;place-items:center;font-size:var(--fs-label);font-weight:700;padding:0 5px}
  ...
  .pc.a .media{background:linear-gradient(140deg,color-mix(in oklab,var(--brass) 22%,var(--ink-2)),var(--ink-2))}.pc.a .media i{color:var(--brass);right:var(--sp-4);bottom:14px}
  .pc.b .media{background:linear-gradient(140deg,color-mix(in oklab,var(--plasma) 22%,var(--ink-2)),var(--ink-2))}.pc.b .media i{color:var(--plasma);right:var(--sp-4);bottom:14px}
  .pc.c .media{background:linear-gradient(140deg,color-mix(in oklab,var(--nebula) 22%,var(--ink-2)),var(--ink-2))}.pc.c .media i{color:var(--nebula);right:var(--sp-4);bottom:14px}
  ...
  .pc .add{font-family:var(--font-mono);font-size:var(--fs-label);letter-spacing:.08em;text-transform:uppercase;background:var(--brass);color:var(--on-brass);border:0;border-radius:var(--r-1);padding:9px var(--sp-3);cursor:pointer;box-shadow:var(--shadow-pop-sm);transition:transform var(--dur-2),filter .12s}
  .pc .add:hover{transform:translateY(-2px);filter:brightness(1.05)}.pc .add:active{transform:translateY(0)}
  .note{font-family:var(--font-mono);font-size:var(--fs-label);letter-spacing:.06em;text-transform:uppercase;color:var(--fg-on-dark-3);text-align:center;padding:34px 0 0}
  ...
  .foot-social{display:flex;gap:14px;margin-top:14px}.foot-social a{color:var(--fg-on-dark-2);font-size:var(--fs-body-l);text-decoration:none}.foot-social a:hover{color:var(--brass)}
