...
export default function Page() {
  ...
  *{box-sizing:border-box}
  ...
  .pc .media img{position:absolute;width:46%;height:46%;object-fit:contain;opacity:.16;left:50%;top:50%;transform:translate(-50%,-50%);image-rendering:pixelated;z-index:0}
...
<section className="hero"><div className="wrap">
  ...
  <p style={{fontFamily: 'var(--font-mono)', fontSize: '11px', letterSpacing: '.1em', textTransform: 'uppercase', margin: '16px 0 0'}}><span>See the full retail kit &#8599;</span></p>
</div></section>
