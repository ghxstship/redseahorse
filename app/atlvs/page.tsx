...
export const metadata: Metadata = {
  title: "ATLVS \u2014 Production & Resource Management",
  description: "ATLVS is GHXSTSHIP's production and resource management platform for experiential teams \u2014 the atlas that charts scope, schedule, budgets, assets, and the eight-phase production lifecycle in one place.",
  alternates: { canonical: "https://ghxstship.tours/atlvs" },
};
...
export default function Page() {
  ...
  /* Product accent: remap the jade accent to the ATLVS color within page content (nav/footer stay global jade). */
  main{--brass:var(--atlvs);--brass-deep:var(--atlvs-deep);--halftone-brass:color-mix(in srgb, var(--atlvs) 16%, transparent)}
` }} />
...
<div className="wrap"><p className="crumbs"><Link href="/">Home</Link> / <span style={{color: 'var(--brass)'}}>ATLVS</span></p></div>
<main>
<section className="hero"><div className="wrap">
  <p className="eyebrow">The Instruments &middot; ATLVS &middot; The Atlas</p>
  <h1>ATLVS<br/>The <span className="pop">Atlas.</span></h1>
  <p className="answer">ATLVS is the production and resource management platform at the center of the GHXSTSHIP fleet — the atlas every build is charted on. Scope, schedule, budgets, assets, and the eight-phase lifecycle live in one system, so producers and clients always know where the project stands.</p>
...
<section className="pad"><div className="wrap">
  ...
  <h2 className="sec">Chart the Whole Build.</h2>
  <div className="sgrid"><div className="scard"><i className="ph-bold ph-blueprint"></i><h3>Production &amp; Scope</h3><p>Scope, deliverables, and the eight-phase Course tracked end to end, with owners and dates at every stop.</p></div><div className="scard"><i className="ph-bold ph-calendar-check"></i><h3>Schedule &amp; Budget</h3><p>Live schedules and budgets that stay in sync as the build moves from discovery to strike.</p></div><div className="scard"><i className="ph-bold ph-stack"></i><h3>Assets &amp; Resources</h3><p>Crew, vendors, inventory, and gear — resourced against the plan and visible to the whole team.</p></div></div>
</div></section>
<section className="pad alt"><div className="wrap">
  <p className="eyebrow">Answers</p>
  <h2 className="sec">FAQ.</h2>
  <div className="faq"><details open><summary>What is ATLVS?<span className="ic">+</span></summary><p className="a">ATLVS is GHXSTSHIP's production and resource management platform — the atlas that charts scope, schedule, budget, assets, and the eight-phase production lifecycle for experiential and entertainment projects.</p></details><details><summary>Who is it for?<span className="ic">+</span></summary><p className="a">Producers, production directors, and clients who need a single source of truth for an experiential build — from a single activation to a multi-stage festival.</p></details><details><summary>How does it fit the fleet?<span className="ic">+</span></summary><p className="a">ATLVS charts the course, COMPVSS points the crew, and GVTEWAY opens the gate — three platforms, one yard, coordinating the whole build.</p></details></div>
</div></section>
<section className="cta"><div className="wrap"><h2>Run It on<br/>ATLVS.</h2>
